...
:::danger[Backups are not encrypted]
Bundles contain your data, credentials, and secrets. Anyone with access can read or reuse them. Keep backups on encrypted, access-controlled storage—never in Downloads or casual cloud storage.
:::
