...
- **MOS never uses it to reach anyone but you.** There is no MOS newsletter, no telemetry email, no "phone home." The one message MOS sends on its own behalf goes to your own address: a warning, at most once a day, when someone is repeatedly trying your password. Otherwise the relay exists only so *your* apps can reach *your* people.
