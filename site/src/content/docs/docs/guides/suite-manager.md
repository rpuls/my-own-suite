...
- **Apps** — the app store and the lifecycle of everything you install: install, connect apps to each other, restart, disable, uninstall, and per-app setup guides. See [Install and manage apps](/docs/guides/apps/).
...
- **Updates** — check for and apply managed updates, and choose your update track. See [Keep your suite up to date](/docs/guides/updates/).
- **Settings** — currently home to the [real domain + HTTPS setup](/docs/guides/https-domain/) for self-hosted installs.
- **Sign out.**
