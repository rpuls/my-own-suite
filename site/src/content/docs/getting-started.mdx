...
Open `Suite Manager` first, sign in, and complete the onboarding flow before you start using the rest of the suite.

## 7. Open the apps

- Homepage: `http://homepage.localhost/`

After you finish onboarding, Homepage becomes your everyday start page. From there you can open the rest of the suite.

If you ever need to return to setup later, use the `Suite Manager` link from Homepage's resources area or open it directly:
