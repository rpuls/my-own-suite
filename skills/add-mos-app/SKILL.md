...
10. Run `npm run apps:catalog` after package changes, then `npm run apps:catalog:check`, focused package/privacy tests, `npm run typecheck`, and the relevant build. Ask the user to run applicable E2E commands.
