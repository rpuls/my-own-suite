...
import * as TechSpecs from '../../../reference/apps/homepage.md';
...
- After restarting Homepage, visible tiles align with your actual stack

Installed suites keep Homepage customization in persistent runtime files, so your dashboard edits can survive MOS updates without changing the source checkout.
Suite Manager includes a simple Customize screen for editing those runtime files directly.
