...
- A candidate that reuses the installed version number with different contents is `updateStatus: 'integrity-error'` and unsupported, rather than being applied as a silent update.
