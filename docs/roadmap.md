...
- Began the offline backup epic with a host-owned backup agent, Suite Manager Backup page, external destination detection, cold Docker-volume archiving, mounted backup-bundle listing, confirmed restore jobs, and persistent backup/restore job state.
