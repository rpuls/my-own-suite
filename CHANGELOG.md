...
- Fixed the V2 Immich package dependency images so its package-owned Postgres/vector and Valkey services can build and initialize with the settings expected by the pinned Immich server release.
