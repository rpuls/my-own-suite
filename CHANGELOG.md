...
- Condensed the V2 branch documentation by replacing oversized temporary research/roadmap docs with a compact active lab plan and durable app-package/integration decisions.
