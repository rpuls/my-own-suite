...
- Added Vaultwarden as the second V2 app package, extending the generic package contract with generated secret setup fields, redacted persisted app config, secret-placeholder runtime projections, package onboarding metadata, and tests that keep Suite Manager core free of app-specific dependencies while preserving Stirling behavior.
