...
- Started a clean Suite Manager-first V2 lab branch for proving control-plane install, browser-based owner creation, and DigitalOcean validation before migrating any optional app catalog behavior.
