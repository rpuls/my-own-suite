...
- Owner-run Hyper-V validation passed for the app catalog, external-package installation, the broader platform E2E flow, and the full backup/restore recovery drills, including replacement-machine restore. Final publisher catalog signing, release checks, and the MOS site deployment cutover remain pre-release gates.
## [0.11.0] - 2026-06-07
