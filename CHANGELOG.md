...
- App manifests can advertise clearly separated demo-deployment targets. The public app drawer now opens a single target directly or reveals a provider menu for multiple targets; Seafile and ONLYOFFICE link to their shared Railway template, while Immich, Radicale, and Vaultwarden each link to their own Railway template.
