...
- Improved backup destination scanning so connected removable/USB block devices appear in Suite Manager even before they are mounted, with guidance to mount them under `/media`, `/mnt`, or `/run/media` before starting a backup.
