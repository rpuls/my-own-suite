...
- Refreshed npm dependencies and pinned app container image digests for the staging validation track, including major docs and Suite Manager toolchain updates that still pass local builds.
