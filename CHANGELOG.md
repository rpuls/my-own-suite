...
- Added the first V2 post-install setup guide slice: package manifests can expose structured guide sections, Radicale shows connection details and client-specific CalDAV/CardDAV instructions from the Apps detail drawer, and Suite Manager persists guide viewed/completed/skipped state per app instance.
