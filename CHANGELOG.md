...
- Owner-run Hyper-V validation passed for the app catalog, external-package installation, the broader platform E2E flow, and the full backup/restore recovery drills, including replacement-machine restore. Branch protection, release metadata/tag alignment, and switching the Cloudflare Pages project to the new GitHub-driven site deploy remain pre-release gates.
## [0.11.0] - 2026-06-07
