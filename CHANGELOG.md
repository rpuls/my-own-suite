...
- **Your backups now have a recovery key you hold.** MOS shows it once before your first backup, with a downloadable recovery kit, and will not back up until you confirm you have saved it; **Show key** under **Backup & Restore** shows it again behind your owner password, and names every place it opens. A replacement machine connects the same drive or bucket, chooses **Enter recovery key**, and restores. Backups taken before this release keep working and move to the new key the first time each destination is opened.
