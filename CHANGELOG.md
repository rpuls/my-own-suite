...
- Retired the repo roadmap document in favor of GitHub Issues for roadmap-like task state, and tightened the durable decision/agent docs around Homepage-driven proxy annotations, host-agent boundaries, and temporary branch planning.
